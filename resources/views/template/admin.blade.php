    ...
    <div class="  w-screen h-screen flex">
        <div class=" bg-white w-48 border-r">
            ...
            <div class=" bg-white flex flex-col justify-center h-full">
                ...
                <div
                    class="{{ Request::is('guru') ? 'border-r-4' : '' }} py-2 px-4  my-2 w-full flex items-center space-x-5 border-blue-500  hover:bg-gray-100 transition-all  font-semibold">
        ...
        <div class="flex-1 bg-gray-50  flex-col flex ">
            <div class="bg-blue-600 flex justify-between items-center py-3 px-10">
                ...
                <a href="{{ route('home') }}" class="font-bold text-white text-xl">SMK Muhammadiyah 2 Gresik </a>
